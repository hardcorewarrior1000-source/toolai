            ...
            <div>
              ...
              <div className="flex items-center gap-6 mt-10 animate-fade-in" style={{ animationDelay: "0.4s" }}>
                <div className="flex items-center gap-2 text-sm">
                  <span className="text-2xl font-bold text-emerald-400">{t.home.stat1Value}</span>
                  <span className="text-zinc-500">{t.home.stat1Label}</span>
                </div>
                <div className="w-px h-8 bg-zinc-800" />
                <div className="flex items-center gap-2 text-sm">
                  <span className="text-2xl font-bold text-emerald-400">{t.home.stat2Value}</span>
                  <span className="text-zinc-500">{t.home.stat2Label}</span>
                </div>
                <div className="w-px h-8 bg-zinc-800" />
                <div className="flex items-center gap-2 text-sm">
                  <span className="text-2xl font-bold text-emerald-400">{t.home.stat3Value}</span>
                  <span className="text-zinc-500">{t.home.stat3Label}</span>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <section className="mb-16">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-bold text-white mb-2">{t.home.howItWorksTitle}</h2>
            <p className="text-zinc-500 text-sm">{t.home.howItWorksSubtitle}</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {howItWorks.map((step, i) => (
              <div key={step.step} className="text-center animate-fade-in" style={{ animationDelay: `${i * 0.1}s` }}>
                ...
                <h3 className="text-white font-semibold mb-1">Step {step.step}: {t.home[step.titleKey]}</h3>
                <p className="text-zinc-500 text-sm">{t.home[step.descKey]}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-white mb-2">{t.home.featuredTitle}</h2>
            <p className="text-zinc-500 text-sm">{t.home.featuredSubtitle}</p>
          </div>
        ...
        <section className="mb-12">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-xl font-bold text-white">{t.home.aiToolsTitle}</h2>
              <p className="text-sm text-zinc-500">{t.home.aiToolsSubtitle}</p>
            </div>
            <Link href="/tools/ai-humanizer" className="text-xs text-emerald-400 hover:text-emerald-300 transition-colors">{t.home.viewAll} →</Link>
          </div>
        ...
        <section className="mb-12">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-xl font-bold text-white">{t.home.devToolsTitle}</h2>
              <p className="text-sm text-zinc-500">{t.home.devToolsSubtitle}</p>
            </div>
            <Link href="/tools/password-generator" className="text-xs text-emerald-400 hover:text-emerald-300 transition-colors">{t.home.viewAll} →</Link>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {devTools.map((tool, i) => (
              <div key={tool.href} className="animate-fade-in" style={{ animationDelay: `${i * 0.05}s` }}>
        ...
        <section className="mb-12">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-xl font-bold text-white">{t.home.cryptoToolsTitle}</h2>
              <p className="text-sm text-zinc-500">{t.home.cryptoToolsSubtitle}</p>
            </div>
            <Link href="/tools/crypto-price-calculator" className="text-xs text-emerald-400 hover:text-emerald-300 transition-colors">{t.home.viewAll} →</Link>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <section className="mt-12 bg-zinc-900/40 border border-zinc-800/50 rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold text-white mb-6">{t.home.whyTitle}</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-sm">
            <div className="animate-fade-in" style={{ animationDelay: "0.1s" }}>
              ...
              <h3 className="text-white font-medium mb-1">{t.home.why1Title}</h3>
              <p className="text-zinc-500">{t.home.why1Desc}</p>
            </div>
            <div className="animate-fade-in" style={{ animationDelay: "0.2s" }}>
              ...
              <h3 className="text-white font-medium mb-1">{t.home.why2Title}</h3>
              <p className="text-zinc-500">{t.home.why2Desc}</p>
            </div>
            <div className="animate-fade-in" style={{ animationDelay: "0.3s" }}>
              ...
              <h3 className="text-white font-medium mb-1">{t.home.why3Title}</h3>
              <p className="text-zinc-500">{t.home.why3Desc}</p>
            </div>
          </div>
        </section>
      </div>
