    ...
    <header className="border-b border-zinc-800 bg-zinc-950/80 backdrop-blur-sm sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm text-zinc-400">
          ...
          <Link href="/tools/ai-humanizer" className="hover:text-white transition-colors">AI Humanizer</Link>
          <Link href="/tools/color-palette" className="hover:text-white transition-colors">Color Palette</Link>
          <Link href="/tools/qr-generator" className="hover:text-white transition-colors">QR Generator</Link>
